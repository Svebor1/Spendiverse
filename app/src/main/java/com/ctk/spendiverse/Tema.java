...
import com.ctk.spendiverse.databinding.ActivityMainBinding;
import com.ctk.spendiverse.databinding.SlideBinding;
...
public class Tema extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int brojSlideovaId = getResources().getIdentifier("com.ctk.spendiverse:integer/"+imeBrojaSlideova,null,null);
        ...
        for (int i = 0; i < brojSlideova; i++) {
            ...
            int idSlikeBroj = getResources().getIdentifier("com.ctk.spendiverse:drawable/"+idSlike, null, null);
            if (idSlikeBroj==0){
                idSlikeBroj = getResources().getIdentifier("com.ctk.spendiverse:drawable/spendiverse_logo_prozirno", null, null);
            }
            String idTeksta = naslovGrupe + "_tema" + redniBrojTeme.toString() + "_text" +Integer.toString(i).toString();
            int idTekstaBroj = getResources().getIdentifier("com.ctk.spendiverse:string/"+idTeksta, null, null);
            list.add(
                    new CarouselItem(

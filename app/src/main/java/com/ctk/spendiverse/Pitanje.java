...
public class Pitanje extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        int kolicinaPitanjaId = getResources().getIdentifier("com.ctk.spendiverse:integer/"+imeBrojaPitanja,null,null);
    ...
    private void ucitavanjePitanja() {
        ...
        int id = getResources().getIdentifier("com.ctk.spendiverse:array/"+idPitanja, null, null);
